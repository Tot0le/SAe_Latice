...
public class CssStyle {
	...
	public static void styleTurnBadge(Label currentTurn, Label iconTurn, VBox turnBadge) {
        // Applies styling to the turn indicator components
    ...
    public static void stylePoolBadge(Label lblPoolTilesNumber, Label iconPool, VBox poolBadge) {
        // Styles the components related to the tile pool
    ...
    public static void styleScoreAndPlayerBadges(Label scorePlayer1, Label scorePlayer2, Label currentPlayer, VBox scoreBadge, VBox playerBadge) {
        // Formats the score displays and player identification areas
    ...
    public static void styleLayoutElements(BorderPane gameLayout, HBox opponentRack) {
        // Configures the appearance of main structural layouts
